...
DEFAULT_PERCENTAGE_SUMMARY = 0.33
...
class TextSummarizer:
    def __init__(self, transformer_path: str):
        ...
        word_embedding_model = Transformer(transformer_path)
        ...
        # initializes NLP object (used for sentence tokenization) if not already done
        #self.nlp = load_nlp_core_news_full()
    ...
    def summarize_text(
        ...
        percentage: Optional[float] = DEFAULT_PERCENTAGE_SUMMARY,
    ) -> List[str]:
