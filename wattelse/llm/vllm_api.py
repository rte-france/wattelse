...
class vLLM_API():
    ...
    def __init__(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.model_name, padding_side="right", use_fast=False) if self.model_name else None
    ...
    def generate(self, prompt, temperature=0.1, max_tokens=512, transform_prompt=True, stream=False) -> str:
